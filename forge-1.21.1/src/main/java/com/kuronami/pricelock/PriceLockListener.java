 ...
 * </ul>
 *
 * <p>Forge 1.21.1 (Forge 52) provides
 * {@code net.minecraftforge.event.entity.player.TradeWithVillagerEvent}
 * (1:1 with NeoForge's event), so both hooks are kept identical to the
 * NeoForge build.
 *
