 ...
 *
 * <p>Forge 1.21.1 (Forge 52) exposes the config builder API as
 * {@code net.minecraftforge.common.ForgeConfigSpec} (NeoForge renamed the
 * identical class to {@code ModConfigSpec}; Forge kept the old name).
 */
